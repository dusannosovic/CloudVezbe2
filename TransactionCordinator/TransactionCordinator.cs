...
namespace TransactionCordinator
{
    ...
    /// </summary>
    internal sealed class TransactionCordinator : StatefulService
    {
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            ...
            {
                return new WcfCommunicationListener<ITransaction>(context, new Transaction(), WcfUtility.CreateTcpListenerBinding(),this.CreateAddress(context,"TransactionService"));
            }
            )
            };
        }
