...
namespace BankService
{
    ...
    internal sealed class BankService : StatefulService
    {
        ...
        public BankService(StatefulServiceContext context)
            : base(context)
        { bankServiceS = new BankServiceS(this.StateManager); }
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            ...
            {
                return new WcfCommunicationListener<IBank>(context, bankServiceS, WcfUtility.CreateTcpListenerBinding(), "BankServiceEndpoint");
            }
            )
            };
        }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            var counts = await this.StateManager.GetOrAddAsync<IReliableDictionary<int, BankData>>("counts");
            AddToDictionary();
            while (true)
            {
